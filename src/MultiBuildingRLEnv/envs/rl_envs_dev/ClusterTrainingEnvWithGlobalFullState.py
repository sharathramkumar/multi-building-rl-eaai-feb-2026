...
class ClusterTrainingEnvWithGlobalFullStateCallback(BaseCallback):
    """
...
class ClusterTrainingEnvWithGlobalFullState(gym.Env):
    def __init__(
        self,
    ...
    def step(self, action):
        ...
        n_over = sum(sub_overrides) / 4
        self.n_overrides += n_over
        # Normalize the observations
        ...
        if self.t_ix < 24:
            ...
            info = {
                ...
                "override_fraction": self.n_overrides / 24.0,
            }
        return (
            next_state,
            reward,
